...
def issue_submission():
    ...
    with db.cursor() as cursor:
        query = "INSERT INTO event_issue (issue_description, issue_time, event_id, emp_id, user_id) VALUES (%s, %s, %s, %s, %s)"
        cursor.execute(query, (issue_description, issue_time, event_id, emp_id, user_id))
        db.commit()
